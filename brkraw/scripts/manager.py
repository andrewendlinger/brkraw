# -*- coding: utf-8 -*-
"""provide all conventional function with backward compatibility.
TODO: Need to add function to send file via FTP server as well as compress only file needed, pruning
"""
from brkraw import __version__, parse_app_config
from brkraw.app.manager.handler import BackupCacheHandler
import click
import datetime
...
@click.group()
def manager():
    """ Sub-command for data management. """
    pass
